...
class AETrainer:
    """
    Generic trainer for manifold-based Autoencoders (AE).

    Handles training and evaluation loops, including:
    - Forward passes through the model
    - Computation of reconstruction + optional topological loss
    ...
    def train(self):
        """
        Train the AE model for a fixed number of epochs.
    ...
    def train_one_epoch(self, epoch, verbose):
        ...
        Returns:
            Tuple[float, float, float]:
                Average total loss, reconstruction loss,
        ...
        for batch_idx, (x, _) in enumerate(dataloader):
            ...
            # Compute AE loss and components
    ...
    def test_one_epoch(self):
        """
        Evaluate the AE on the test dataset.
