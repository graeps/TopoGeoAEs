...
all_configs = {
    "exp1a_nested_spheres": make_config(exp1a_config),
    "exp1b_nested_spheres": make_config(exp1b_config),
    "exp1c_nested_spheres": make_config(exp1c_config),
    "exp1d_nested_spheres": make_config(exp1d_config),
    "exp1e_nested_spheres": make_config(exp1e_config),
    "exp1f_nested_spheres": make_config(exp1f_config),
    "exp1g_nested_spheres": make_config(exp1g_config),
}
